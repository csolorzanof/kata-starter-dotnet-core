...
namespace Kata.Spec
{
    ...
    public class when_user_input_is_one_number
    {
        ...
        It should_return_that_same_number = () => { _result.Should().Be(1); };
        static Calculator _systemUnderTest;
        static int _result;
    }
    ...
    public class when_user_input_is_multiple_numbers_with_new_line
    {
        Establish _context = () =>
        {
            _systemUnderTest = new Calculator();
    ...
    public class when_using_a_custom_delimiter
    {
        ...
        It should_eturn_the_sum_of_all_the_numbers = () => { _result.Should().Be(6); };
        static Calculator _systemUnderTest;
        static int _result;
    }

    public class when_user_input_contains_negative_numbers
    {
        Establish _context = () =>
        {
            _systemUnderTest = new Calculator();
    ...
    public class when_user_input_contains_multiple_negatives
    {
        ...
        It should_throw_an_exception_with_all_the_negatives = () => { _result.Message.Should().Be("negatives not allowed: -2, -4"); };
        static Calculator _systemUnderTest;
        static Exception _result;
    }

    public class when_input_contains_numbers_over_1000
    {
        Establish _context = () =>
        {
            _systemUnderTest = new Calculator();
        ...
        Because of = () => { _result = _systemUnderTest.Add("1,1003,2"); };

        It should_sum_only_numbers_less_than_a_1000 = () => { _result.Should().Be(3); };
        static Calculator _systemUnderTest;
        static int _result;
    }
