...
namespace Kata.Spec
{
    ...
    public class when_summing_two_numbers
    {
        ...
        It should_return_the_sum_of_those_two_number = () => { _result.Should().Be(3); };
        static Calculator _systemUnderTest;
        static int _result;
    }
    ...
    public class when_summing_an_unknown_amount_of_number
    {
        ...
        It should_calculate_the_sum_of_all_the_numbers = () => { _result.Should().Be(6); };
        static Calculator _systemUnderTest;
        static int _result;
    }

    public class when_using_a_new_line_as_a_separator
    {
        Establish _context = () =>
        {
            _systemUnderTest = new Calculator();
    ...
    public class when_summing_multiple_numbers_with_a_custom_delimiter
    {
        Establish _context = () =>
        {
            _systemUnderTest = new Calculator();
