...
namespace Kata.Spec
{
    ...
    public class when_input_contains_one_negative_number
    {
        ...
        It should_raise_an_exception = () => { _result.Message.Should().Be("negatives not allowed: -1"); };
        static Calculator _systemUnderTest;
    ...
    public class when_user_input_includes_multiple_negatives
    {
        ...
        It should_raise_an_exception_with_all_negatives_listed = () => { _result.Message.Should().Be("negatives not allowed: -2, -4"); };
        static Calculator _systemUnderTest;
        static Exception _result;
    }

    public class when_numbers_are_greater_than_1000
    {
        Establish _context = () =>
        {
            _systemUnderTest = new Calculator();
